...
Комплексный SQL-проект для исследования, анализа и отчётности по данным продаж интернет-магазина.

Проект построен по принципу пошагового анализа данных — от первичного исследования структуры базы до создания полноценных отчётов по клиентам и продуктам.

> Проект использует синтаксис **T-SQL** (Microsoft SQL Server).

## 🎯 Цели проекта

- Изучить структуру базы данных и модель данных (измерения + факты)
- Провести разведочный анализ данных (EDA)
- Выполнить анализ продаж, клиентов и продуктов
- Построить сегментацию клиентов и продуктов
- Создать готовые отчёты (views) для бизнес-аналитики
